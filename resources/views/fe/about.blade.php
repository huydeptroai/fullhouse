            ...
            <div class="our-staff">
                <div class="slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-margin="30" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"4"}}'>
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="Vincent">
                                <figure><img src="{{ asset('/frontend/images/member-lucia.jpg') }}" alt="Vincent"></figure>
                            </a>
                        </div>
                        <div class="info">
                            <b class="name">Vincent</b>
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="Hana">
                                <figure><img src="{{ asset('/frontend/images/member-lucia.jpg') }}" alt=""></figure>
                            </a>
                        </div>
                        <div class="info">
                            <b class="name">Hana</b>
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="">
                                <figure><img src="{{ asset('/frontend/images/member-braum.jpg') }}" alt=""></figure>
                            </a>
                        </div>
                        <div class="info">
                            <b class="name">Kelvin</b>
