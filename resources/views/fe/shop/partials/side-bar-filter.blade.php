        ...
        <div class="widget-content">
            <ul class="list-category">
                <li class="category-item has-child-cate">
                    <a href="{{ route('searchByCategoryName',['category_name'=>'Office furniture']) }}" class="cate-link">Office Furniture</a>
                ...
                <li class="category-item has-child-cate">
                    <a href="{{ route('searchByCategoryName',['category_name'=>'Living furniture']) }}" class="cate-link">Living Furniture</a>
                    <span class="toggle-control">+</span>
                    <ul class="sub-cate">
                ...
                <li class="category-item has-child-cate">
                    <a href="{{ route('searchByCategoryName',['category_name'=>'Bedroom furniture']) }}" class="cate-link">Bedroom Furniture</a>
                    <span class="toggle-control">+</span>
                    <ul class="sub-cate">
