					...
					<div class="col-md-6">
						<div class="card-body">
							...
							<div class="form-group">
								...
								<small style="color:red;">{{$errors->first('category_name_1')}}</small>
							</div>
							<div class="form-group">
								...
								<small style="color:red;">{{$errors->first('category_name_2')}}</small>
							</div>
					...
					<div class="col-md-6">
						<div class="card-body">
							...
							<div class="form-group">
								...
								<small style="color:red;">{{$errors->first('category_intro')}}</small>
							</div>
