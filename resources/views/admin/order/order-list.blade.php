                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-head-fixed table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('admin.order.invoice', $order->id)}}">{{$order->id}}
                                            </a>
                                        </td>
                                        <td>
                                            {{ \Carbon\Carbon::createFromFormat('Y-m-d H:m:s', $order->created_at)->format('d-m-Y')}}
                                        </td>
                                        <td>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-3">
                                                        ...
                                                        <p class="text-muted mb-0">
                                                            Date: {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $order->order_date)->format('d-m-Y')}}
                                                        </p>
                                                    </div>
                                                </div>
                                            </a>
                                            ...
                                            <div class="d-flex justify-content-start">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item text-center" href="{{ Route('admin.product.edit', $order->id)}}">
                                                        ...
                                                        <form class="dropdown-item text-center" action="{{Route('admin.product.destroy', $order->id)}}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="8">
                                            <a class="btn btn-success" href="#">Alo</a>
                                        </th>
